  ...
  <div class="fullscreen-modal" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">          
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class=""><strong>PLAN DE ACCIÓN CORRECTIVAS Y/O PREVENTIVAS PROPUESTAS</strong></h5>  
                </div>
            ...
            <div class='row'>
                <div class="col-md-12 OPCIONES BOTONES-PLAN" style="display: none">
                    <div class="form-group">
                        ...
                        <button type='button' class='btn btn-primary' id='btn-aprobar-plan' onclick="aprobarRechazarPlan(this)" ><span class='glyphicon glyphicon-ok'> Aprobar</span></button>                
                        <button type='button' class='btn btn-danger' id='btn-rechazar-plan' onclick="aprobarRechazarPlan(this)" ><span class='glyphicon glyphicon-remove'> Rechazar</span></button>                
                    </div>
                </div> 
            </div>                    
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">          
            <form enctype="multipart/form-data" id="form2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="description">Pantalla</label>
                        <select class="form-control select2" id="proceso" name="proceso" style="width: 100%;">
                            <option value='Solicitud'>Solicitud</option>
                            <option value='Buzon'>Buzon</option>                            
                            <option value='Plan accion'>Plan accion</option>
...
$("#plan-select-estadoPlan").change(function(){
                        ...
                        render:function(data, type, row)                        
                                {
                                    ...
                                    if (data["estadoSolicitud"] == "G"){
                                        ...
                                        if(data["us"]=="100%" && data["sg"]=="100%"){
                                            html = "<button type='button' value='"+data['codigoSolicitudDocumento']+"' name='1' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Visualizar solicitud'><i class='fa fa-eye'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='8' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Documentos'><i class='fa fa-paperclip'></i></button><button type='button' class='btn btn-success btn-circle' value='"+data['codigoSolicitudDocumento']+"' name='2' onclick='gestionBuzon(this)' data-toggle='tooltip' data-placement='top' title='Confirmar solicitud' disabled='true'><i class='fa fa-check'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='3' onclick='gestionBuzon(this)' class='btn btn-danger btn-circle' data-toggle='tooltip' data-placement='top' title='Rechazar solicitud' disabled='true'><i class='fa fa-close'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='4' onclick='gestionBuzon(this)' class='btn btn-default btn-circle'  data-toggle='tooltip' data-placement='top' title='Visualizar retroalimentación'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='5' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Agregar evaluación de consecuencias' disabled='true'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='6' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Plan de acción'><i class='fa fa-calendar-minus-o'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='7' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Cerrar documento'><i class='fa fa-file-zip-o'></i></button>";
                                        }else{
                                            html = "<button type='button' value='"+data['codigoSolicitudDocumento']+"' name='1' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Visualizar solicitud'><i class='fa fa-eye'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='8' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Documentos'><i class='fa fa-paperclip'></i></button><button type='button' class='btn btn-success btn-circle' value='"+data['codigoSolicitudDocumento']+"' name='2' onclick='gestionBuzon(this)' data-toggle='tooltip' data-placement='top' title='Confirmar solicitud' disabled='true'><i class='fa fa-check'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='3' onclick='gestionBuzon(this)' class='btn btn-danger btn-circle' data-toggle='tooltip' data-placement='top' title='Rechazar solicitud' disabled='true'><i class='fa fa-close'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='4' onclick='gestionBuzon(this)' class='btn btn-default btn-circle'  data-toggle='tooltip' data-placement='top' title='Visualizar retroalimentación'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='5' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Agregar evaluación de consecuencias' disabled='true'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='6' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Plan de acción'><i class='fa fa-calendar-minus-o'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='7' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Cerrar documento' disabled='true'><i class='fa fa-file-zip-o'></i></button>";
                                        }                                                                                 
                                    }else if(data["estadoSolicitud"] == "CE"){
                                        html = "<button type='button' value='"+data['codigoSolicitudDocumento']+"' name='1' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Visualizar solicitud' ><i class='fa fa-eye'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='8' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Documentos' disabled='true'><i class='fa fa-paperclip'></i></button><button type='button' class='btn btn-success btn-circle' value='"+data['codigoSolicitudDocumento']+"' name='2' onclick='gestionBuzon(this)' data-toggle='tooltip' data-placement='top' title='Confirmar solicitud' disabled='true'><i class='fa fa-check'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='3' onclick='gestionBuzon(this)' class='btn btn-danger btn-circle' data-toggle='tooltip' data-placement='top' title='Rechazar solicitud' disabled='true'><i class='fa fa-close'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='4' onclick='gestionBuzon(this)' class='btn btn-default btn-circle'  data-toggle='tooltip' data-placement='top' title='Visualizar retroalimentación'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='5' onclick='gestionBuzon(this)' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Agregar evaluación de consecuencias' disabled='true'><i class='fa fa-commenting'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='6' onclick='gestionBuzon(this)' class='btn btn-warning btn-circle' data-toggle='tooltip' data-placement='top' title='Plan de acción' ><i class='fa fa-calendar-minus-o'></i></button><button type='button' value='"+data['codigoSolicitudDocumento']+"' name='7' onclick='' class='btn btn-primary btn-circle' data-toggle='tooltip' data-placement='top' title='Cerrar documento' disabled='true'><i class='fa fa-file-zip-o'></i></button>";
                                    }
                                    
                                    return html;
                                },
                            }
                            //,{data: "codigoSolicitudDocumento" } localhost/nqr/web/index.php?r=print
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {//janchundia
                            ...
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {
                                        var html = "<a href='#' name='areaResponsable' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'>"+data['areaResponsable']+"</a>";                                                                
                                        return html;
                                    },
                            }
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {
                                        var html = "<a href='#' name='gestor' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'>"+data['gestor']+"</a>";                                                                
                                        return html;
                                    },
                            }
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {
                                        var html = "<a href='#' name='tipoReclamo' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'>"+data['tipoReclamo']+"</a>";                                                                
                                        return html;
                                    },
                            }  
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {
                                        var html = "<a href='#' name='clasificacion' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'>"+data['clasificacion']+"</a>";                                                                
                                        return html;
                                    },
                            }  
                            ,{"data": null,
                                render:function(data, type, row)                        
                                    {
                                        var html = "<a href='#' name='subclasificacion' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'>"+data['subclasificacion']+"</a>";                                                                
                                        return html;
                                    },
                            }                                                                                                                 
                                ...
                                render:function(data, type, row)                        
                                    {
                                        ...
                                        if (data["procede"] == 0){
                                        html = "<h1 style='display:none'>0</h1><a href='#' name='procede' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'><center><input type='checkbox' value='"+data['procede']+"' name='procede' id='"+data['codigoSolicitudDocumento']+"' disabled></center></a>";
                                        }else{
                                        html = "<h1 style='display:none'>1</h1><input type='hidden' value='1'><a href='#' name='procede' id='"+data['codigoSolicitudDocumento']+"' onclick='gestionBuzonAdicionales(this)'><center><input type='checkbox' value='"+data['procede']+"' name='procede' id='"+data['codigoSolicitudDocumento']+"' checked disabled></center></a>";
                                        }                                                                
                                        return html;
                                    },
                            }                            
...
function gestionBuzonAdicionales (boton)
{
    ...
    }else if(boton.name == "procede"){
        swal({
            title: "El documento procede o no procede",
            text: "Desea continuar con el cambio?",
            type: "info",
            showCancelButton: true,
            closeOnConfirm: false,
            ...
            showLoaderOnConfirm: true}, function () {      
                $.ajax({
                    ...
                    type : 'POST',      
                    datatype : 'json',
                    data : {'codigoSolicitudDocumento':codigoSolicitudDocumento,'accion':'I','opcion':"19"}, 
                        success: function(data) { 
                            $("#ModalcamposAdicionales").modal('hide');
                            var obj = jQuery.parseJSON(data);
                            $.each(obj, function(i, item) {         
...
function gestionBuzon(valor)
{
   ...
   }else if(accion == "8"){//Modal de archivos
        obtenerArchivos(codigoSolicitudDocumento);
        ...
        $.ajax({
            ...
            data : {'codigoSolicitudDocumento':codigoSolicitudDocumento,'tipoDocumento':tipoDocumento,'accion':'V','opcion':2}, 
                success: function(data) {                    
                    var obj = jQuery.parseJSON(data);
                    $.each(obj, function(i, item) {
                        console.log(item.estadoSolicitud.trim());
...
function obtenerArchivos(codigoSolicitudDocumento){
    //var codigoSolicitudDocumento = //$("#codigoSolicitudDocumento").val();
    ...
    $.ajax({
        ...
        data : valores, 
            beforeSend: function() {  
                ...
                var codigoSolicitudDocumento = $("#codigoSolicitudDocumento2").val();
                obtenerArchivos(codigoSolicitudDocumento);
            },error:function(data){
                swal("FATAL!", data, "error"); 
            }
